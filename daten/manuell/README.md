...
|---|---|---|
| `band1_p545_PG1601_Erlaeuterungen_Steuerarten_t0.csv` | Haushaltsplan 2026/2027, Band 1 (Stand 20.05.2026), PDF-Seite 545 (gedruckt 539), Allgemeine Finanzwirtschaft, Erläuterungen zu Zeile 01 | Tabelle ohne Linien im Erläuterungstext; `extract_tables()` findet sie nicht. |
