...
|---|---|---|---|
| Produktgruppen = Produktbereich | `haushaltsquerschnitt.csv` | 1188 | 0 |
| Produktbereiche = Gesamtsumme | `haushaltsquerschnitt.csv` | 72 | 2 |
| Zeilenformeln | `haushaltsquerschnitt.csv` | 2380 | 0 |
...
| Haushaltsquerschnitt = Gesamtübersicht | `haushaltsquerschnitt.csv vs. agg_tables/Gesamtuebersicht_Einnahmen_Ausgaben_2026_2027.csv` | 3440 | 0 |
...
| Besoldungsgruppen = Gruppensumme | `stellenplan-beta.csv` | 16 | 0 |
| Gruppensummen = Insgesamt | `stellenplan-beta.csv` | 4 | 0 |

## Produktbereiche = Gesamtsumme (`haushaltsquerschnitt.csv`)
