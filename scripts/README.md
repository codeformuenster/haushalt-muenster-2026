...
| `pipeline/planspiel_daten.py` | Daten für die Planspiel-Seite der Vue-App: Zeilen 01-17 (Erträge und Aufwendungen) 2026/2027 aus den Teilergebnisplänen der 68 Produktgruppen (Band 1, S. 15-558) und dem Gesamtergebnisplan (Band 1, S. 9), dazu die Summe der freiwilligen Zuschüsse und der Grundsteuerertrag (Band 2, S. 20). Prüft, ob die Produktgruppen zusammen den Gesamtergebnisplan ergeben. Braucht Gesamtübersicht und Zuschüsse. | `vue-project/src/data/planspiel.json`; Exit-Code 1 bei Abweichungen über 1 € |
